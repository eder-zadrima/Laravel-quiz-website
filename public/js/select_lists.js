function add_select_lists_word(element) {
    ...
    element.parent().parent().prepend('<li><div><input type="radio" name="' + name + '" value="Click and Type content..."><label data-editable>Click and Type content...</label></div><a onclick="{$(this).parent().remove();update_slide_view_nav();}"><i class="fas fa-trash-alt"></i></a></li>');
