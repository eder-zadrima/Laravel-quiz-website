function add_word(element) {
    element.parent().parent().prepend('<li><label data-editable>Click and Type content...</label><a onclick="{$(this).parent().remove();update_slide_view_nav();}"><i class="fas fa-trash-alt"></i></a></li>');
