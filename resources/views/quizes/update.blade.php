                        ...
                        <div class="col-md-12">
                            <form method="POST" action="{{ url('/quizes') }}/{{ $quiz->id }}" class="create_form">
                                ...
                                <input id="type_id" type="text"
                                       ...
                                       value="{{ $quiz->type_id }}" required autocomplete="type_id" autofocus hidden>
                                ...
                                <div class="form-group row" style="align-items: center">
                                    ...
                                    <div class="col-md-7">
                                        <input id="is_feedback" type="checkbox"
                                               ...
                                               value="feedback_checked" {{$quiz->is_feedback ? 'checked' : ''}} autocomplete="is_feedback" autofocus>
                                        @error('is_feedback')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="feedback_correct" type="text"
                                               ...
                                               value="{{ $quiz->feedback_correct }}" required autocomplete="feedback_correct" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="feedback_incorrect" type="text"
                                               ...
                                               value="{{ $quiz->feedback_incorrect }}" required autocomplete="feedback_incorrect" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input id="feedback_try_again" type="text"
                                               ...
                                               value="{{ $quiz->feedback_try_again }}" required autocomplete="feedback_try_again" autofocus>
