                ...
                <div id="entries_container">
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" id="entries_table">
                        ...
                        @foreach ($users as $user)
                            <tr id="row_29">
                                <td class="me_action"><input type="checkbox" id="entry_29" name="entry_29" value="1"></td>
...
<!--                </div>-->
    ...
    <div id="dialog-confirm-user-delete" title="Are you sure you want to delete selected users?" class="buttons"
        ...
        <p id="dialog-confirm-user-delete-msg">
            ...
            <strong id="dialog-confirm-user-delete-info">The user will be deleted permanently and no longer has access
