...
class ExamController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Quiz::create([
            ...
            'media' => null,
            'order' => 0,
            'answer_element' => '<div class="slide_view_answer_element slide_view_group" style="width: 80%;top: 100px;left: 10%;z-index: 2;padding: 10px;position:absolute;"><div class="col-md-12"><div contenteditable="true"><div class="cancel_drag">Your Score: %%</div><div class="cancel_drag">Passing Score: ##</div></div></div></div>',
